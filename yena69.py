...
kh = LINETCR.LINE()
#kh.login(qr=True)
kh.login(token="EnwqndXl6id2ZSS6Ye80.X7ONBO4L4YtA49fO3i6lua.JkalQQe1ZSrD575n8sr1ReVlkfOidzO/fCRjF5bz2TU=")
kh.loginResult()

kj = LINETCR.LINE()
#kj.login(qr=True)
kj.login(token="EnsqTku5UozwOf2BdUYf.oVwyNFPWGPJZC00RELiFVW.ZMINhKgiGyAwHyIF+WKr0lInouN+QnMBFIxKQ4m4n7k=")
kj.loginResult()
