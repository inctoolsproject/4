...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EnPk3V1Zla854MeQAIT9.3UrGMEjECFh9gbFk6EFekq.vYCBuYq1qUXK1nf/oCvIaCCuoBxC+A5VMZp95FvXH24=")
cl.loginResult()

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token="En4KG8n3Axy1dVdjTgBe.F6loN/ws9FaPqFRwqoggJG.jqx0KH2ZLBv5JNpxSPnPE/ACr/7lvOjqYZLvrRB5aEY=")
ki.loginResult()
...
kn = LINETCR.LINE()
#kn.login(qr=True)
kn.login(token="EnoyYxUZB5Xv7Bl9Ys57.KN6gqRyZQ0iuRiU5jNIj1W.SxC9+Q+ahlwaT+Wz124+tfYzek6HekkdDDqbipYbLrw=")
kn.loginResult()
...
kp = LINETCR.LINE()
#kp.login(qr=True)
kp.login(token="EnwOOwOK4e4Uyu5uyXBa.am5VEhHU3Oh3X2olVwx66G.mQ5Hs2DVNitNFLNKm5INJzlDELTBEm1GhfrcVc2ibsk=")
kp.loginResult()
...
kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token="EngqjAX9djgqsY8BVCOc.cTXHQLZwcjas2Whcxxlhda./6K1IVcI3KrpoWRMMhrBsjbsUPQeQit9hrCTyA0C/Hc=")
kr.loginResult()
...
꧁U.K_KILLER꧂ Qr on/off
꧁U.K_KILLER꧂ Backup on/off
꧁U.K_KILLER꧂ Protect On/off
...
�U_K�✒ C͍͇̪̲͎̯͎̫̩̽̅̈́̅̌́̍̐ŗ̛͔̳͔̦́̋͛̎e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟t̢̠̻̗̠͙̦͒̉̈̎͂̐͒͑o̸̡̲̜̯̤͚̠̬͊̓̌̄̒͠r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̨̻̪͓̦̋̾̂̽̎͘͜͜[ 🇲🇨〖🕉unni͡° ͜ʖ ͡°oppa🕉〗🇲🇨 ] ��✒•┅───── """
...
autoleaveroom = []
targets = []
Bots = ["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
self = ["udee46099e25e71f1fd1817cae9e7c429",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
admin = "udee46099e25e71f1fd1817cae9e7c429"
owner = "udee46099e25e71f1fd1817cae9e7c429"
admsa = "udee46099e25e71f1fd1817cae9e7c429"
adminMID = "udee46099e25e71f1fd1817cae9e7c429"
wait = {
    'contact':False,
    'autoJoin':False,
...
#==========================no TAG =================
                ...
                cl.sendText(msg.to,"Ngapain di keluarin dudul")
                cl.kickoutFromGroup(msg.to, [msg.from_])
                cl.sendText(msg.to,"Kapok sapa suruh bilang keluar")

            elif msg.text in ["summon","tagall","Tagall","Summon","mention","Mention","."]:
                cl.sendText(msg.to,"Idih tag pake bot")
                cl.kickoutFromGroup(msg.to,[msg.from_])
                cl.sendText(msg.to,"Nah kan tag pake bot lagi")

#            elif "@💋🕉ùnni͡° ͜ʖ ͡°oppa🕉✒" in msg.text:
 #               cl.sendText(msg.to, "Jangan tag kakak lagi gak mod...\nKalau penting PM saja...")
  #              cl.kickoutFromGroup(msg.to,[msg.from_])
   #             cl.sendText(msg.to,"Rasain sapa suruh tag gw...")
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                adm = 'udee46099e25e71f1fd1817cae9e7c429'
...
#========COMAND PROTECT========[=
                ...
                if wait["Backup"] == True: md+="��❂͜͡🕵️➣Backup : → ✔\n"
                else:md+="��❂͜͡🕵️➣Backup : → ❌\n"
                if wait["qr"] == True: md+="��❂͜͡🕵️➣Protect QR : → ✔\n"
                else:md+="��❂͜͡🕵️➣Protect QR : → ❌\n"
...
#============================================
                ...
                if msg.from_ in admin:
                              ...
                              cnt.to = msg.to
                              cl.sendText(msg.to,"Maaf ya kak kena sebut")
                              cl.sendMessage(cnt)
