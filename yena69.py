...
ki = LINETCR.LINE()
ki.login(token="EmWjWh8xSlCdoaBS0Gy3.9qPM7NC2vWiRtQTZ/x4SyW.mHz+Xbj+HUT/XFktibC6ozt7yy8tQUBH6VUbsmvzJJI=")
ki.loginResult()
...
kd = LINETCR.LINE()
kd.login(token="EmXZa7hbkqLH5s2JcDH6.xkaL7HAdfdzB4bRIIC04jG.og9kDQdqz20CFA1VX7E2eZ0BKJ0EvRoW+PyicFw8ukY=")
kd.loginResult()
...
��✒ C͍͇̪̲͎̯͎̫̩̽̅̈́̅̌́̍̐ŗ̛͔̳͔̦́̋͛̎e̶̮̳͕͍̺̼̱͎͛̃̾̍̑̐ǻ͕͍̻̭̟̪͒́́̎̕͘̕͟t̢̠̻̗̠͙̦͒̉̈̎͂̐͒͑o̸̡̲̜̯̤͚̠̬͊̓̌̄̒͠r̵̺̲̗̩͙̐̇̾̐͐̏̃̓́̊ B̝̪̭͓͍̺͐͂̑̅̓͗͗̈́͢y͚͔̝͖̮̤͚̅̉̑̐̓̀̋̊͂͜͜͢͞:̶̨̻̪͓̦̻̋̾̂̽̎͘͜͜💋🕉unni͡° ͜ʖ ͡°oppa🕉✒ ��✒•┅───── """
...
#===========================================
        ...
        if op.type == 11:
            if not op.param2 in Bots:
              if wait["qr"] == True:
                try:
                    klist=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kn,ko,kp,kq,kr,ks]
                    kicker = random.choice(klist)
                    G = kicker.getGroup(op.param1)
                    G.preventJoinByTicket = True
                    cl.updateGroup(G)
