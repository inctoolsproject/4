...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token="EnglcDa00DaCXyAhkub8.MQvnSQmxLZyecm+cYLEska.B6wvaPOUvoO6TeJ/HSLoduT08oL/Lp+Ts9/qyNtXnv0=")
kr.loginResult()
...
Bots=[mid]
owner=["u9aa54db2a31797360408cfc2ca579228",mid]
admin=["u9aa54db2a31797360408cfc2ca579228",mid]
baby=["u060faad0b4c2f6561f4bbdeef3670312"]
    ...
    try:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        kr.sendText(op.param1, "halooo " + "☞ " + nick[0] + " ☜" + "\jangan ngitip lo. . .\nkayak maling aja ngintai orang  (-__-) ")
                                    else:
                                        kr.sendText(op.param1, "hoeeee " + "☞ " + nick[1] + " ☜" + "\nsenang amat jadi tukan ngintip. . .\nsering ngintip orang mandi ya (-__-) ")
                                else:
                                    kr.sendText(op.param1, "hadehhhhhhh " + "☞ " + Name + " ☜" + "\nNgapain Kak Ngintip Aja???\ngabung sini kakak biar saling akrab ...  ")
                        else:
                            pass
                    else:
                        pass
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u9aa54db2a31797360408cfc2ca579228',"}
                kr.sendMessage(msg)
                kr.sendMessage(msg)
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "u9aa54db2a31797360408cfc2ca579228"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'❂➣ Creator yang pea plus p3  􀜁􀄯􏿿')
...
#==============================================================================#
              ...
              if msg.from_ in owner:
                ...
                if msg.toType == 2:
                   ...
                   for target in targets:
            ...
            elif "kick on" in msg.text.lower():
                    try:
                        kr.sendText(msg.to,"Oeeee mau ngapain luuu?")
                        kr.kickoutFromGroup(msg.to,[msg.from_])
                    except:
                        pass
                    ...
                    try:
                        kr.sendText(msg.to,"Hayooooooooo mau ngapain?")
                        kr.kickoutFromGroup(msg.to,[msg.from_])
                    except:
                        pass
...
#--------------------------------------------------------
            ...
            elif msg.text in ["keket glist"]: #Melihat List Group
                if msg.from_ in owner:
            ...
            elif "keket asupka " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("keket asupka ","")
                    if gid == "":
                ...
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ...
                        try:
                            ...
                            pass
            elif "keket megs " in msg.text:
                if msg.from_ in owner:
                    gName = msg.text.replace("keket megs ","")
            ...
            elif msg.text in ["keket muach"]:
                if msg.from_ in owner:
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': "u9aa54db2a31797360408cfc2ca579228',"}
                    kr.sendMessage(msg)
            elif msg.text in ["Keket","keket"]:
                if msg.from_ in owner:
                    kr.sendText(msg.to,"keket masih aktif Bebz...!!!")
#=============================================
        if op.type == 17:
