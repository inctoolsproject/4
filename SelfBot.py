...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="Epnn9OOznNHRDyRfhTK3.BYv5MSepCurmE04bZMOzaW.B1wUUopbJKwx710yQy3Ajt19SxRDyphwBIOOaeE3QRo=")
cl.loginResult()
...
Bots=["u6f25799ac10f71444c7b4e01ce6a1903"]
admin=["u6f25799ac10f71444c7b4e01ce6a1903"]
wait = {
    "likeOn":True,
    "alwayRead":False,
    "detectMention":True,    
