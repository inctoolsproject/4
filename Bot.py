...
cl = Master.LINE()
cl.login(token="En60w8Dp9wYVhslfrhL9.3UrGMEjECFh9gbFk6EFekq.oRUs1kQ0k302swrAF80U8EHVXMuGwBJb2wD5dzREf+w=")
cl.loginResult()                      
...
PELAYANAN?Message ="""Ṭ̡͎͔̟̮̥̬̳̙͖͔͙̬̮̰͎̯̦̏ͫͨ̀ͬ̋͊̌͞Ė̶͚̝̰̗̻̩̻̗͍̠̘͇̃ͫ́̚̚͘͞͝A̧̨͍̞̰̰͈̜̠̼̝̳͇̻͉̤͇̭ͫ͒̊̐̂ͮͫ̐̐̿̏̕͝M̧͋̽̌͆͆̉͏̶̢̪͕͖͞ ͇̖̩̠̺̐ͬͫ̄͊̀͝͝͡͞ͅC̡̨̹̥̫͉̣͖̘̹̤̘͕̙͌̃̐͌̄͆͑ͪͭ͗͆ͮ͡ͅY̡̒ͧ̍̾̃ͫ̿̋͗̓ͤͫ̃ͩ͝͏̷̮͎̫͖̙̪̦̩̲̥̘͖̦ͅB̷̍ͨͧͫ̍ͬ͡҉̥̘̝̲͍̪̳͎̰E̵̢̒͋̅̽̀ͧ͆͒͋ͪ͗̾ͭ̓͞҉̴̟͚̼̞̺͙͖̳ͅͅR̀͛͗̿҉̨̣̤͖̹̻̻͙͎ͅ ̶̶̧̄͌͛̄͊̈͢͏̮̦̻͈̳̲̩͕̳̜̮̲͈̘̹ͅC̵̛̍̀ͯ̎ͬͪͤ̆̋͑͑ͥ͌̀̂҉̛̦̼̦̘͚͕͎̮͡R͂̔̏̎͒ͨ̏̄͋̉ͮ͆͂̔̔͗̒ͭ͢͏͎̼̗̩̹̳̦̻̣͎͈̲͙͎̭̼A̗͉̫̰͖̅ͩ͗͒̌̍͌̿̀Z̵̶̺̗̩̦̗̘̮̲̟̰̺̟̹̥̖̈́̋ͧ̀ͣ̎̿̄ͫͩͬͣͨ͌̃̐͘͘Y̴̢͆̆́ͥ̂̾̀҉͕͕̲̝͍̰͙͔̦͇̝̠̼͝ͅ
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
「ೋ• ͜͡COMMAND FOR ͜͡GROUP•ೋ」
▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬
|| ☣➤ Cancel        
...
╠═══════_════════╝
╔════[ CREATOR BOT]════╗
║line.me/ti/p/~mhmmdcakli17        ║
║                                                             ║
║Note : Bot hanya bisa di gunakan   ║
║             oleh admin                             ║
╚════[CopyRigth2017]════╝
                ...
                if msg.to in wait2['readPoint']:
                   if wait2["ROM"][msg.to].items() == []:
                      ...
                      for rom in wait2["ROM"][msg.to].items():
                       ...
                       cl.sendText(msg.to, "╔═══════ F A N S   D I B A L  I K   L A Y A R ════════%s\n╠═══════════════\n%s╠═══════════════\n║ T͜͡ ͜͡E ͜͡A ͜͡M" C͜͡Y͜͡ ͜͡B ͡E ͜͡ ͜͡R" ͜͡C ͜͡RA͜͡ Z͜͡ ͜͡Y ║ [%s]\n╚═══════════════"  \n\n||Pelaku CCTV /👇👇👇||\n%sOrang Ini Gak Normal Plak\n\nBuang Aja Ke Laut\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
       	        else:
...
#----------------------ADMIN COMMAND------------------------------#
            ...
            if msg.text.lower() in ["mention"]:
                ...
                start = time.time()
                cl.sendText(msg.to, " ══════l MOHON BERSABAR AMPE DOI PEKA l══════ ")
                ...
                cl.sendMessage(msg)
                cl.sendText(msg.to,"INFO CREATOR\n╔════════════════════════\n╠Instagram: @Divya_putryD\n╠LINE: Http://line.me/ti/p/~mhmmdcakli17") ╠NamaCreator:  ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\n \n╚════════════════════════")
...
#            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
#            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by ͜͡❂ʍңʍʍð΅ҫǟκᶫΐ͜͡❂ D\n\nHttp://line.me/ti/p/~mhmmdcakli17")
#            print "Like"
#            print "Like"
#            print "Like"
#          except:
